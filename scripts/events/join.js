...
let gifPath = __dirname + '/Nayan/join/received_908287014131424.mp4';
...
https://www.facebook.com/mdkajol.hossen.140

🔵WHATSAPP NUMBER: wa.me/+8801312737981

🟢SUPPORT EMAIL: mahaburpk479@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
